...
<head>
	...
	<link rel="stylesheet" type="text/css" href="chi_tiet_sp1.css">
...
<header>
	...
	<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #444; height: 70px;">
	  <a class="navbar-brand" id = "chooseCT" href="#">Choose another country or region to see content specific to your location.</a>
	...
	<div>
		...
		<div class="sp-1">
			...
			<img src="../img-large/<?php echo $row['image']; ?>" style="width: 70%;height: 598px;display: inline-block;float: right;">
		</div>
		<?php }?>
		...
		<div class="sp-all">
			...
			<div style="height: 80px;background-color: #f5f5f7;"></div>
			<div style="height: 30px;background-color: #f5f5f7;"></div>
			<div class="sp-4">
